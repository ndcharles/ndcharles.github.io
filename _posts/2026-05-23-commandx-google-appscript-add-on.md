...
---
This is a story of me creating CommandX. The single reason is to have all the tools I need while processing data in one tool instead of multiple free and paid tools. So I created my own internal too.
